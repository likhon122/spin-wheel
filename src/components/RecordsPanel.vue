<template>
  <div class="records-panel">
    ...
    <div class="hide-records-container">
      <a href="#" class="closeButton" @click.prevent.stop="close">Close</a>
    </div>
  </div>
</template>
...
.closeButton {
  ...
  background-color: #003161; /* Warm brown color for button */
...
.closeButton:hover {
  background-color: #004282; /* Darker warm tone for focused input */
}
</style>
